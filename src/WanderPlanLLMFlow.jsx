...
function isLikelyGibberishBucketInput(userMsg){
  var raw=String(userMsg||"").trim();
  if(!raw)return false;
  return !isLikelyBucketDestinationName(raw);
}
