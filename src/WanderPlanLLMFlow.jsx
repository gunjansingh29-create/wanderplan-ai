...
function resolveBucketKeywordDestinations(userMsg,budget){
  var normalizedQuery=String(userMsg||"").toLowerCase().replace(/[^a-z\s]/g," ").replace(/\s+/g," ").trim();
  if(normalizedQuery!=="beach"&&normalizedQuery!=="beaches")return [];
  var budgetKey=String(budget||"").trim().toLowerCase();
  // Cost arrays are ordered as [Maldives, Bali, Phuket].
  var costByBudget={
    budget:[120,95,90],
