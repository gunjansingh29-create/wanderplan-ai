...
export async function setupApiMocks(page: Page): Promise<void> {
  ...
  const companionPayload = () => ({
    companion: {
      ...
      current_item: { activity_id: 'act-1', time_slot: '09:00-10:00', title: 'Land in Tokyo', category: 'flight', location: 'Haneda Airport' },
      next_item: { activity_id: 'act-2', time_slot: '13:00-14:00', title: 'Check in at hotel', category: 'checkin', location: 'Shinjuku' },
      stays: [
        {
          destination: 'Tokyo',
          name: 'Shinjuku Grand',
